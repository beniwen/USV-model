...
% 使用 nlgreyestOptions 配置参数辨识
options = nlgreyestOptions('Display', 'on');
options.SearchMethod = 'grad';  % 使用 优化算法
options.SearchOptions.MaxIter = 1000;  % 最大迭代次数

% 执行参数辨识
nlgr = nlgreyest(z, nlgr, options);
